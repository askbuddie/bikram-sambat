...
type Formats = 
  'YYYY' | 'YYYY-MM' | 'YYYY/MM' | 'YYYY MM' | 'YYYY-MM-DD' | 'YYYY/MM/DD' | 'YYYY MM DD' | 
  'DD MMMM YYYY' | 'DD-MMMM-YYYY' | 'DD/MMMM/YYYY' | 'DD-MM-YYYY' | 'DD/MM/YYYY' | 'DD MM YYYY' |
  'MM-DD' | 'MM/DD' | 'MM DD' | 'YY-MM-DD' | 'YY/MM/DD' | 'YY MM DD' | 
  'YYY-MM-DD' | 'YYY/MM/DD' | 'YYY MM DD';
